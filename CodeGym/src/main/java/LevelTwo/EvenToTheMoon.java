...
//            "Nope."
//            "Neither did I. Now this information will be used a lot. To avoid
//            having to manually calculate it each time, implement a getWeight(int)
//            method that takes a person's body weight on Earth (in newtons), and
//            returns the weight of that person on the moon (in newtons).
...
//            •	The getWeight method should correctly convert the Earth weight
